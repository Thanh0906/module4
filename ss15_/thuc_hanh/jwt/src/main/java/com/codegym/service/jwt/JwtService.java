...
@Component
@Service
public class JwtService {//Bước 11: Tạo file JwtService để tạo ra token sau khi đăng nhập thành công
    private static final String SECRET_KEY = "123456789";
    private static final long EXPIRE_TIME = 86400000000L;
    private static final Logger logger = LoggerFactory.getLogger(JwtService.class.getName());

//phương thức generateTokenLogin được sử dụng để sinh ra token sau khi đăng nhập thành công
